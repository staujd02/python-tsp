...
class Trajectory_Counts_test(unittest.TestCase):
    ...
    def test_if_a_trajectory_register_demonstrates_consistency(self):
        ...
        self.assertFalse(TrajectoryCounts.demonstratesConsistency(zeroRegister))
        misMatchRegister = array.array('i', [0, 1, 0])
        self.assertFalse(TrajectoryCounts.demonstratesConsistency(misMatchRegister))
        onesRegister = array.array('i', [1] * 4)
        self.assertTrue(TrajectoryCounts.demonstratesConsistency(onesRegister))
